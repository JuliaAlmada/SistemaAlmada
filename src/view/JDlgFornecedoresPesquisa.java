 ...
 super(parent, modal);
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "NOME", "EMAIL ", "TELEFONE", "CNPJ", "ENDEREÇO C"
            }
        ));
    ...
    private void jBtnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnOkActionPerformed
        ...
        Fornecedores fornecedores = fornecedoresControle.getBean(rowSel);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDlgFornecedoresPesquisa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDlgFornecedoresPesquisa dialog = new JDlgFornecedoresPesquisa(new javax.swing.JFrame(), true);
